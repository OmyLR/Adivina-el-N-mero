		...
		<div class="col-md-5 offset-md-3">
			<div class="row col-md-12 boxInterval">
				<form method="POST" action="jugar">
					<p> Elige un Intervalo mínimo y máximo para el juego</p>
					<div class="form-group row">
						<label class="col-form-label col-md-2">Mínimo: </label>
						<div class="col-md-9">
							<input type="number" class="form-control" value="" placeholder="Mínimo" name="min">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-form-label col-md-2">Máximo:</label>
						<div class="col-md-9">
